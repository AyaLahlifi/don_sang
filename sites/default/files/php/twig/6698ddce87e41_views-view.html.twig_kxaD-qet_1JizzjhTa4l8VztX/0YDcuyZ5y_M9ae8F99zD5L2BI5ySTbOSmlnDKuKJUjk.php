...
class __TwigTemplate_e77f716bc560b17a2c9a684375eea33d extends Template
{
    private $source;
    private $macros = [];
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["id", "attributes", "title_prefix", "title", "title_suffix", "header", "exposed", "attachment_before", "rows", "empty", "pager", "attachment_after", "more", "footer", "feed_icons"]);    }
    ...
    {
        return new Source("", "themes/vani/templates/views/views-view.html.twig", "C:\\xampp\\htdocs\\Drupalwebb\\themes\\vani\\templates\\views\\views-view.html.twig");
    }
