...
class __TwigTemplate_065d76acbf59f0ce828ad06b3ce786a3 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"row\">
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
            // line 26
            echo "      <div ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["row_attributes"] ?? null), "addClass", [twig_get_attribute($this->env, $this->source, ($context["options"] ?? null), "row_class", [], "any", false, false, true, 26)], "method", false, false, true, 26), 26, $this->source), "html", null, true);
            echo ">
        ";
            // line 27
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["title", "id", "attributes", "rows", "row_attributes", "options"]);    }
    ...
    {
        return new Source("", "modules/views_bootstrap/templates/views-bootstrap-grid.html.twig", "C:\\xampp\\htdocs\\Drupalwebb\\modules\\views_bootstrap\\templates\\views-bootstrap-grid.html.twig");
    }
