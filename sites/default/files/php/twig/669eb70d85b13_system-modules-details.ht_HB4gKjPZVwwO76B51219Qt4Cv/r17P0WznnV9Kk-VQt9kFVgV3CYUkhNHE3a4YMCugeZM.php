...
class __TwigTemplate_fffd6ea2fa2b31da844af702fe9db057 extends Template
{
    private $source;
    private $macros = [];
  ...
  <tbody>
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["module"]) {
            // line 35
            echo "      ";
            $context["zebra"] = twig_cycle(["odd", "even"], $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, true, 35), 35, $this->source));
            // line 36
            echo "      <tr";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["module"], "attributes", [], "any", false, false, true, 36), "addClass", [($context["zebra"] ?? null)], "method", false, false, true, 36), 36, $this->source), "html", null, true);
            echo ">
        <td class=\"checkbox\">
          ";
            // line 38
...
";
    ...
    {
        return new Source("", "core/themes/stable9/templates/admin/system-modules-details.html.twig", "C:\\xampp\\htdocs\\Drupalwebb\\core\\themes\\stable9\\templates\\admin\\system-modules-details.html.twig");
    }
