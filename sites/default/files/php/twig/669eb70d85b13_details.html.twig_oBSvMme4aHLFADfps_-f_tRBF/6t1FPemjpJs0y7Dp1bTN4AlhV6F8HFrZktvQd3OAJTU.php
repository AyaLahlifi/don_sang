...
/* themes/vani/templates/form/details.html.twig */
class __TwigTemplate_c08350ba7c03115416ae2bfce5aa28e6 extends Template
{
    private $source;
    private $macros = [];
...
($context["required"] ?? null)) ? ("form-required") : (""))];
            // line 25
            echo "    <summary";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["summary_attributes"] ?? null), "addClass", [($context["summary_classes"] ?? null)], "method", false, false, true, 25), 25, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return "themes/vani/templates/form/details.html.twig";
    }
    ...
    {
        return new Source("", "themes/vani/templates/form/details.html.twig", "C:\\xampp\\htdocs\\Drupalwebb\\themes\\vani\\templates\\form\\details.html.twig");
    }
