...
class __TwigTemplate_a5cd9b30c383ea9b92895eb0dfe58f2c extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["theme_group"]) {
            ...
            echo "    ";
            // line 34
            $context["theme_group_classes"] = ["system-themes-list", ("system-themes-list-" . $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source,             // line 36
$context["theme_group"], "state", [], "any", false, false, true, 36), 36, $this->source)), "clearfix"];
            // line 40
            echo "    <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["theme_group"], "attributes", [], "any", false, false, true, 40), "addClass", [($context["theme_group_classes"] ?? null)], "method", false, false, true, 40), 40, $this->source), "html", null, true);
            echo ">
      ...
      ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["theme"]) {
                ...
                echo "        ";
                // line 44
                $context["theme_classes"] = [((twig_get_attribute($this->env, $this->source,                 // line 45
$context["theme"], "is_default", [], "any", false, false, true, 45)) ? ("theme-default") : ("")), ((twig_get_attribute($this->env, $this->source,                 // line 46
$context["theme"], "is_admin", [], "any", false, false, true, 46)) ? ("theme-admin") : ("")), "theme-selector", "clearfix"];
                // line 51
                echo "        <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["theme"], "attributes", [], "any", false, false, true, 51), "addClass", [($context["theme_classes"] ?? null)], "method", false, false, true, 51), 51, $this->source), "html", null, true);
                echo ">
          ";
                // line 52
...
";
    ...
    {
        return new Source("", "core/themes/stable9/templates/admin/system-themes-page.html.twig", "C:\\xampp\\htdocs\\Drupalwebb\\core\\themes\\stable9\\templates\\admin\\system-themes-page.html.twig");
    }
