...
class MoAuthSetupTwoFactor extends FormBase
{
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if(isset($mo_db_values['mo_auth_firstuser_id'])) {
        $form['markup_top'] = array(
            '#markup' => '<div class="mo_2fa_welcome_message">' . t('The admin who has activated module on this site can configure/reconfigure 2FA using this tab.') . '</div>'
        );
    }
