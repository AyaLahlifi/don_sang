  ...
  public function __construct() {
    ...
    public function buildForm(array $form, FormStateInterface $form_state)
    {
        ...
        $form['markup_top_2'] = array(
            '#markup' => '<div class=""><div class="mo_2fa_table_layout mo_container_second_factor">'
        );
        ...
        $form['mo_user_management']['starting_markup'] = array(
          '#markup' => '<br><div class="mo_2fa_highlight_background_note">' . t('You can manage 2FA for the end user accounts from this tab.') . t( ' Please note that the user has to setup the 2FA again upon next login.') . '</div><br>',
        );
